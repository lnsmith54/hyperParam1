...
$TOOLS/caffe.bin train \
    --snapshot=examples/bk_imagenet/snapshots/resnetCM9585CLR.051WD3e-6BS32_20Epochs_iter_80000.solverstate \
    --gpu=all  --solver=examples/bk_imagenet/queues/resnet/bsolver36.prototxt $@ 2>&1 | tee examples/bk_imagenet/results/resnetCM9585CLR.051WD3e-6BS32_20Epochs2_1
