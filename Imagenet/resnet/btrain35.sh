...
$TOOLS/caffe.bin train \
    --gpu=all  --solver=examples/bk_imagenet/queues/resnet/bsolver35.prototxt $@ 2>&1 | tee examples/bk_imagenet/results/resnetCM9585CLR.051WD1e-5BS32_20Epochs1_2

exit
#    --snapshot=examples/bk_imagenet/snapshots/resnetCM9585CLR.051WD1e-6BS32_20Epochs_iter_20000.solverstate  \
