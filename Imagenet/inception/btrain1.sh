...
OUT=inception-resnetCM9585CLR.051WD1e-7BS28_100Epochs5_1
...
$TOOLS/caffe.bin train \
     --snapshot=examples/bk_imagenet/snapshots/inception-resnetCM9585CLR.051WD1e-7BS28_100Epochs_iter_575000.solverstate  \
    --gpu=all  --solver=examples/bk_imagenet/queues/inception/bsolver1.prototxt $@ 2>&1 | tee examples/bk_imagenet/results/$OUT
