...
OUT=inception-resnetCM9585CLR.051WD1e-7BS28_50Epochs3_2
...
$TOOLS/caffe.bin train \
     --snapshot=examples/bk_imagenet/snapshots/inception-resnetCM9585CLR.051WD1e-7BS28_50Epochs_iter_160000.solverstate  \
