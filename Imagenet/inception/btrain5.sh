...
OUT=inception-resnetCM9585CLR.051WD1e-5BS28_20Epochs3_2
...
$TOOLS/caffe.bin train \
     --snapshot=examples/bk_imagenet/snapshots/inception-resnetCM9585CLR.051WD1e-5BS28_20Epochs_iter_50000.solverstate  \
     --gpu=all  --solver=examples/bk_imagenet/queues/inception/bsolver5.prototxt $@ 2>&1 | tee examples/bk_imagenet/results/$OUT
