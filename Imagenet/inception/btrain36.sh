...
OUT=inception-resnetCM9585CLR.051WD3e-6BS28_20Epochs2_2
...
$TOOLS/caffe.bin train \
     --snapshot=examples/bk_imagenet/snapshots/inception-resnetCM9585CLR.051WD3e-6BS28_20Epochs_iter_125000.solverstate    \
     --gpu=all  --solver=examples/bk_imagenet/queues/inception/bsolver36.prototxt $@ 2>&1 | tee examples/bk_imagenet/results/$OUT
