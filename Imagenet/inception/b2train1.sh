...
OUT=inception-resnetCM9585CLR.051WD1e-7BS28_100Epochs5_2
...
$TOOLS/caffe.bin train \
     --snapshot=examples/bk_imagenet/snapshots/inception-resnetCM9585CLR.051WD1e-7BS28_100Epochs_iter_700000.solverstate   \
